...
%patch1 -p1
# This one is not used by CentOS packagers
# %patch2 -p1
...
rm -rf $RPM_BUILD_ROOT/etc/raddb/sites-available/tls.orig
...
%post
%{?el7:%systemd_post radiusd.service}
if [ $1 -eq 1 ]; then           # install
  %{?el6:/sbin/chkconfig --add radiusd}
...
* Tue May 30 2017 Stefan Paetow <stefan.paetow@jisc.ac.uk> - 3.0.14-2
- Re-enabled Moonshot configuration
- Backported to CentOS 6.8
